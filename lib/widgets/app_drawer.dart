      ...
      child: ListView(
        children: <Widget>[
          UserAccountsDrawerHeader(
            accountName: Text(
                currentUser == null ? "Account Name" : currentUser.displayName),
            accountEmail:
                Text(currentUser == null ? "@user-name" : currentUser.username),
          ...
          listItem(context, text: 'How This Works', icon: Icons.info,
              onTap: () {
